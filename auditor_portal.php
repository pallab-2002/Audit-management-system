...
<body style="background: linear-gradient(135deg,#d498c6,#1294a7,#c7e4d9 );">
    ...
    <div class="row">
        ...
        <div class="column">
            <div class="buttons">
                <button name="auditoption" onclick="window.location.href='auditor_audit_form.php';">DoAudit</button>
                <button name="auditoption" onclick="window.location.href='auditor_view.php';">ViewAudit</button>
